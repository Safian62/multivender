...
const UserInbox = () => {
  ...
  useEffect(() => {
    axios
      .get(`${server}/conservation/get-all-conservation-user/${user._id}`, {
...
const UserInboxC = ({
  ...
  const { seller } = useSelector((state) => state.seller);
  return (
    <div className="w-full  h-[74vh] flex flex-col justify-between">
      {/* MESSAGE HEADER */}
            ...
            >
              ...
              {item.images && (
                <img
                  ...
                  className="w-[250px] h-[250px] object-cover rounded-[10px] ml-3 mb-2"
                  alt=""
                />
              )}
